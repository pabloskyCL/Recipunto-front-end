...
const emit = defineEmits(['setRecipoint'])
...
const selectMarker: LeafletEventHandlerFn = (e: LeafletEvent) => {
    ...
    emit('setRecipoint', selectedRecipoint.value.id)
}
...
<template>
    <div class="grid h-5/6 w-full pl-[56px]">
                ...
                <div class="relative hidden flex-col items-start gap-8 md:flex">
                    <div class="grid w-full items-start gap-6">
                        ...
                        <fieldset class="grid gap-6 rounded-lg border p-4">
                            ...
                            <div id="recipoint-list" class="overflow-y-auto h-56">
